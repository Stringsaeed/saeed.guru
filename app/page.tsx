        ...
        <div className="mx-auto max-w-2xl px-6 py-16">
          <article className="space-y-8">
            <h1 className="text-3xl font-bold leading-tight text-foreground sm:text-4xl">
              Muhammed Saeed, React Native engineer in Dubai
            </h1>
            ...
            <nav aria-label="Featured pages" className="flex flex-wrap gap-3">
              <Link
                href="/blog"
                className="rounded-md border border-border px-3 py-2 text-sm font-medium text-foreground transition-colors hover:border-primary/50"
              >
                Blog
              </Link>
              <Link
