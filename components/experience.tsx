        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            {experiences.map((exp, index) => (
              ...
              >
                {/* Timeline dot */}
                <div className="absolute left-0 md:left-auto md:right-0 top-0 w-4 h-4 rounded-full bg-primary z-10 md:transform md:translate-x-1/2"></div>
                ...
                <div className="bg-card rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow">
                  ...
                  <div className="flex items-center mb-4 text-sm text-foreground/60">
                    <Calendar className="h-4 w-4 mr-1" />
                    <span>{exp.period}</span>
                  </div>

                  <div className="mb-4">
                    <div className="text-sm font-medium text-primary mb-1">Technology Stack:</div>
                    <div className="text-foreground/80">{exp.stack}</div>
                  </div>

                  <div>
                    <div className="text-sm font-medium text-primary mb-2">Key Contributions:</div>
